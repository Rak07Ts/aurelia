...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-24 md:space-y-36 pb-24">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center pt-24 pb-16 overflow-hidden bg-palette-charcoal_950 text-white">
        ...
        <div className="absolute inset-0 z-0">
          <img
            ...
            className="w-full h-full object-cover object-center opacity-45 scale-105 animate-pulse transition-all duration-1000"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-palette-charcoal_950 via-palette-charcoal_950/40 to-palette-charcoal_950/70" />
        </div>

        <Container className="relative z-10 text-center flex flex-col items-center">
          <MotionReveal variant="fade" delay={100}>
            <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-md text-palette-sand_200 text-caption uppercase tracking-[0.25em] font-medium mb-6 border border-white/15">
              <Sparkles size={13} className="text-palette-bronze_500" /> Contemporary Luxury Hospitality
            </span>
          </MotionReveal>

          <MotionReveal variant="fade_up" delay={200}>
            <h1 className="font-display text-display-m sm:text-display-l md:text-display-xl font-normal text-white max-w-5xl tracking-tight leading-[0.95] text-balance">
              Places Worth Remembering.
            </h1>
          </MotionReveal>

          <MotionReveal variant="fade_up" delay={300}>
            <p className="font-body text-body-m sm:text-body-l text-palette-sand_200/90 max-w-2xl mt-6 sm:mt-8 font-light leading-relaxed">
          ...
          <MotionReveal variant="fade_up" delay={400} className="w-full max-w-4xl mt-10 sm:mt-12">
            <div className="bg-surface-primary text-text-primary p-3 sm:p-4 rounded-[4px] shadow-2xl border border-border-subtle flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 text-left">
              <div
                onClick={() => navigate('/stays')}
                className="flex-1 px-4 py-2 hover:bg-surface-secondary/60 rounded cursor-pointer transition-colors"
              >
                <span className="block text-[11px] uppercase tracking-uppercase font-medium text-text-muted">
                  Sanctuaries
                </span>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/50 text-caption tracking-widest uppercase">
      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <MotionReveal variant="fade_left" className="lg:col-span-6">
            <div className="relative rounded-[2px] overflow-hidden border border-border-subtle bg-surface-secondary shadow-medium">
              <img
              ...
              />
              <div className="p-6 bg-surface-primary/95 backdrop-blur-sm border-t border-border-subtle">
                <p className="font-display italic text-body-l text-text-primary">
      ...
      <Container>
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <h2 className="font-display text-heading-l sm:text-heading-xl text-text-primary">
      ...
      <section className="bg-surface-secondary/60 py-24 border-y border-border-subtle">
        <Container>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <span className="text-label uppercase tracking-uppercase text-accent-primary font-semibold block mb-2">
      ...
      {/* 7. Brand Values Grid */}
      <section className="bg-surface-primary py-20 border-t border-border-subtle">
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {BRAND_INFO.values.map((val, idx) => (
              <div
                key={idx}
                className="p-8 rounded-[2px] border border-border-subtle bg-surface-secondary/40 space-y-3"
              >
                ...
                <p className="text-body-s text-text-secondary leading-relaxed font-light">
                  {val.desc}
                </p>
              </div>
            ))}
      ...
      <Container>
        <div className="relative rounded-[4px] overflow-hidden bg-palette-charcoal_950 text-white p-10 sm:p-16 md:p-20 text-center flex flex-col items-center">
          ...
          <div className="relative z-10 max-w-2xl space-y-6">
            <span className="text-label uppercase tracking-uppercase text-palette-sand_200 font-medium block">
              Begin Your Journey
            </span>
            <h2 className="font-display text-heading-l sm:text-heading-xl text-white font-normal leading-tight">
              Find your sanctuary of restorative solitude.
            </h2>
            <p className="text-body-m text-palette-stone_300 leading-relaxed font-light">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button
                ...
                className="w-full sm:w-auto text-white border-white/30 bg-white/10 hover:bg-white/20 hover:text-white"
              >
                Direct Reservation
              </Button>
            </div>
